...
Give it a go. You now have a very powerful tool in your tool belt. Figure out your custom project thresholds, integrate it as part of your project [makefile]({% post_url 2015-02-08-mobile-ci---makefiles %}) or [Fastfile](http://oclint.org/), run it as CI job and output reports using one of the plugins available.
